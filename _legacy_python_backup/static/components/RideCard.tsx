      ...
      { buttonAction &&
        <div className="bg-gray-50 p-3">
            <button
                ...
                className={`w-full text-white font-bold py-3 px-4 rounded-lg transition duration-300 shadow-sm ${!isActionable ? 'bg-gray-400 cursor-not-allowed' : buttonAction.className}`}
              >
                {buttonAction.text}
            </button>
        </div>
