        ...
        <div className="space-y-8">
            ...
            <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <button onClick={() => setActiveView('test_map')} className="flex items-center justify-center p-4 bg-yellow-50 text-yellow-800 rounded-lg hover:bg-yellow-100 transition-colors duration-300">
                        <MapIcon className="w-6 h-6 mr-3"/>
                        <span className="text-md font-semibold">Test Map Component</span>
                    </button>
                </div>
            </div>
