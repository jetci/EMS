...
const MapPicker: React.FC<MapPickerProps> = ({ onLocationChange, position }) => {
  ...
  if (!apiKey) {
    return (
        <div 
            ...
            className="flex flex-col items-center justify-center h-full bg-gray-100 text-gray-600 p-4 text-center border border-gray-200 rounded-lg"
        >
